            ...
            while var_tem <= len(barang):
                if input_kode_barang == barang[var_tem - 1][0]:
                    ...
                    if input_jumlah_beli.isdigit() == True:
                        ...
                        if input_jumlah_beli <= int(barang[var_tem-1][2]): 
                            total_harga_beli = input_jumlah_beli*(barang[var_tem-1][3]) 
                            print(f'Anda akan membeli {barang[var_tem-1][1]} sebanyak {input_jumlah_beli} Pcs seharga Rp{total_harga_beli}')
                            ...
                            if simpan_data_beli == 'Y':
                                ...
                                if input_uang == total_harga_beli:
                                    ...
                                    print()
                                    barang[var_tem-1][2] -= input_jumlah_beli 
                                    print('=======================================Daftar Barang Prelim Project=======================================')
                                    print(format_spasi.format(*judul_kolom))
                                    print('==========================================================================================================')
                ...
                if input_kode_barang == barang[var_tem-1][0] :
                    ...
                    if simpan_data_2 == 'Y':
                        ...
                        if update_nama_kolom == judul_kolom[0]: 
                            kode_baru = input('Masukan kode  barang baru: ').upper()
                            simpan_data_2 = input(f'Apakah nda ingin mengubah kode barang {barang[var_tem-1][0]} menjadi {kode_baru}? (Y/T):').upper()
                            followup(simpan_data_2)
                            if simpan_data_2 == 'Y':
                                barang[var_tem-1][0] = kode_baru
                                print('=======================================Daftar Barang Prelim Project=======================================')
                                print(format_spasi.format(*judul_kolom))
                                print('==========================================================================================================')
                                print(format_spasi.format(*barang[var_tem-1]))
                            ...
                            if stok_baru.isdigit() == True:
                                ...
                                print()
                                break
                            simpan_data_2 = input(f'Apakah Anda ingin mengubah stok barang {barang[var_tem-1][2]} menjadi {stok_baru}? (Y/T):').upper()
                            followup(simpan_data_2)
                            if simpan_data_2 == 'Y':
                                barang[var_tem-1][2] = stok_baru
                                print('=======================================Daftar Barang Prelim Project=======================================')
                                print(format_spasi.format(*judul_kolom))
                                print('==========================================================================================================')
                                print(format_spasi.format(*barang[var_tem-1]))
                            ...
                            if harga_baru.isdigit() == True:
                                ...
                                print()
                                break
                            simpan_data_2 = input(f'Apakah Anda ingin mengubah {barang[var_tem-1][3]} menjadi {harga_baru}? (Y/T):').upper()
                            followup(simpan_data_2)
                            if simpan_data_2 == 'Y':
                                barang[var_tem-1][3] = harga_baru
                                print('=======================================Daftar Barang Prelim Project=======================================')
                                print(format_spasi.format(*judul_kolom))
                                print('==========================================================================================================')
                                print(format_spasi.format(*barang[var_tem-1]))
                            ...
                            simpan_data_2 = input(f'Apakah Anda ingin mengubah {barang[var_tem-1][4]} menjadi {sales_baru}? (Y/T):').upper()
                            followup(simpan_data_2)
                            if simpan_data_2 == 'Y':
                                barang[var_tem-1][4] = sales_baru
                                print('=======================================Daftar Barang Prelim Project=======================================')
                                print(format_spasi.format(*judul_kolom))
                                print('==========================================================================================================')
                                print(format_spasi.format(*barang[var_tem-1]))
